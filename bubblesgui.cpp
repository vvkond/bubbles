...
bubblesGui::bubblesGui( QWidget* parent, Qt::WindowFlags fl )
    : QDialog( parent, fl )
{
  setupUi( this );
  ...
  QString format( "<html><body><h3>%1</h3>%2<h3>%3</h3>%4<p><a href=http://qgis.org/api>"
                  ...
                  "<h4>bubbles.h, bubbles.cpp</h4>%12"
                  "<h4>bubblesgui.ui</h4>%13"
                  "<h4>bubblesgui.cpp, bubblesgui.h</h4>%14"
                  "<h4>bubbles.qrc</h4>%15"
                  "<h4>bubbles.png</h4>%16"
                  "<h4>README</h4>%17"
...
void bubblesGui::on_buttonBox_accepted()
{
  //close the dialog
  accept();
}

void bubblesGui::on_buttonBox_rejected()
{
  reject();
}

void bubblesGui::on_buttonBox_helpRequested()
{
